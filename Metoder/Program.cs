...
namespace LabMetoder
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Oppgave 3, en static metode er en som er alltid sant og kan ikke bli byttet på eller endret på av annen kode, mens en non static metode kan ha det som står inni bli usant

            Console.WriteLine(MyFavQuotes());
        }
